...
const (
	smallSlotDuration = 2 * time.Minute  // small planner slot duration we might ignore
	smallGapDuration  = 29 * time.Minute // small gap duration between planner slots we might ignore
)
